function[PD,Pstor,Pphev]=battery_(Pload,Pres,Celphev,Ephevinit,Estorinit,Pphevmax,Pstormax,c)
...
nonlcon = [];
x0 = [0,0,0,0];
options = optimoptions(@fmincon,'Algorithm','interior-point ','MaxIterations',10000);
